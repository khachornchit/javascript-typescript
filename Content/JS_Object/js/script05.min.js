...
module.exports = function () {
    ...
    this.AppendText = function (vText) {
        this.Append(this.CreateDiv(vText));
    };
...
function Display() {
    ...
    employees.forEach(element => {
        pluto.AppendElement(DisplayEmployee(element));
    });
};
...
function DisplayEmployee(employee) {
    ...
    for (key in employee) {
        divEmployee.appendChild(pluto.CreateDiv(key + " : " + employee[key]));
    }
    divEmployee.appendChild(pluto.CreateNewLine());
    return divEmployee;
};
